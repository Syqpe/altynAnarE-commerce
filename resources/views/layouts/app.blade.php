    ...
    <div class="header-middle">
        <div class="header-middle__container">
            ...
            <div class="support-client">
                <div class="support-client__body">
                        <div class="support-client__logo">
                            <a href="/" title="Malias">
                                <img src="img/logoAltyn.png" alt="AltynAnar">
                            </a>
                        </div>
                    ...
                    <!-- Start Single-Support -->
                        <div class="single-support">
                            ...
                            <div class="support-text">
                                <h1 class="zero gfont-1">Быстрая доставка</h1>
                                <p>доставим до 45 минут</p>
                            </div>
                        </div>
                                        <!-- End Single-Support -->
                                        <!-- Start Single-Support -->
...
{{--            </div>--}}
    ...
    <div class="mainmenu-area">
        <div class="container mainmenu-area__container">
            <!-- <div class="row">
                <div class="col-md-12"> -->
                    ...
                    <div class="mainmenu">
                        <nav>
                            <ul>
                                ...
                                <li class="hot"><a href="shop.html">Скидки и Акции</a></li>
...
<script>
    let burger_icon = document.querySelector(".mainmenu__burger");
    burger_icon.addEventListener("click", function (e) {
        burger_icon.classList.toggle("_active");
        document.querySelector(".mainmenu").classList.toggle("_active");
    });

    let user_menu = document.querySelector(".mainmenu");
    user_menu.addEventListener("click", function (e) {
        burger_icon.classList.toggle("_active");
...
{{--        <script src="{{asset('/js/panel.js')}}" type="text/javascript"></script>--}}
